...
async function main() {
  ...
  const files = [
    { src: 'media__1784876178328.jpg', dst: 'diaphragm-ccaw-d750-silver-1.jpg' },
    { src: 'media__1784876178415.png', dst: 'diaphragm-ccaw-d750-silver-2.jpg' }
  ];
  ...
  const productName = "SPEAKER DIAPHRAGM CCAW D-750 8 OHM SILVER";
  const productSlug = "speaker-diaphragm-ccaw-d-750-8-ohm-silver";
  ...
  const { data: productData, error: productError } = await supabase
    ...
    .insert({
      ...
      name: productName,
      slug: productSlug,
      short_desc: "Premium replacement speaker diaphragm featuring a custom silver anodized finish and heavy-duty CCAW (Copper Clad Aluminum Wire) voice coil for D-750 drivers.",
      long_desc: "This premium B2B replacement speaker diaphragm features a custom silver-anodized dome and frame assembly tailored for D-750 professional compression drivers. Wound with high-temperature Copper Clad Aluminum Wire (CCAW) on a stable former, it provides clean, precise high-frequency reproduction with superior power limits. Ideal for professional sound reinforcement and wholesale parts distribution.",
      featured_image: "/diaphragm-ccaw-d750-silver-1.jpg",
      is_hidden: false,
      is_featured: true,
      tags: ["diaphragms", "ccaw", "compression drivers", "8 ohm", "silver diaphragm", "d-750", "speaker diaphragm"],
      ...
      sort_order: 6,
      seo_meta: {
        title: "SPEAKER DIAPHRAGM CCAW D-750 8 OHM SILVER | Global Speaker Parts",
        description: "Premium silver-anodized replacement speaker diaphragm featuring a high-temperature CCAW voice coil for D-750 drivers."
      }
    })
    .select()
    .single();
  ...
  const imageUrls = [
    "/diaphragm-ccaw-d750-silver-1.jpg",
    "/diaphragm-ccaw-d750-silver-2.jpg"
  ];
  ...
  console.log("D-750 Silver Diaphragm product listing fully complete!");
}
