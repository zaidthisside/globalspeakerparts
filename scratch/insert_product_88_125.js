...
async function main() {
  ...
  const srcName = 'media__1784955887626.jpg';
  const dstName = 'surround-88-125.jpg';
  ...
  const productName = "SPEAKER FOAM SURROUND ID-88 MM, OD-125 MM";
  const productSlug = "speaker-foam-surround-id-88-mm-od-125-mm";
  ...
  const { data: productData, error: productError } = await supabase
    ...
    .insert({
      ...
      name: productName,
      slug: productSlug,
      short_desc: "Premium speaker foam surround replacement edge featuring a 125 mm outer diameter and 88 mm inner diameter.",
      long_desc: "This premium speaker foam surround is engineered for precision repairs of woofers and midrange drivers. Crafted from durable, highly flexible black foam, it provides excellent excursion compliance and resonance damping to restore original sound quality. Fits standard 5-inch to 5.25-inch drivers requiring precise ID-88mm and OD-125mm alignment.",
      featured_image: `/${dstName}`,
      is_hidden: false,
      is_featured: false,
      tags: ["speaker surrounds", "foam surround", "speaker repair", "5 inch", "speaker edge"],
      ...
      sort_order: 0,
      seo_meta: {
        title: "Speaker Foam Surround ID 88mm OD 125mm Edge | Global Speaker Parts",
        description: "Premium replacement speaker foam surround edge for driver repair. Specs: OD 125mm, ID 88mm, Roll 113mm, Piston 98mm."
      }
    })
    .select()
    .single();
  ...
  const { data: variantData, error: variantError } = await supabase
    ...
    .insert({
      ...
      specs: {
        ...
        "Outer Diameter (OD)": "125 mm",
        "Inner Diameter (ID)": "88 mm",
        "Roll Diameter": "113 mm",
  ...
  console.log("Foam Surround 88-125 product listing fully complete!");
}
