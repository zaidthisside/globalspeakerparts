...
async function main() {
  ...
  const srcName = 'diaphragm_45_99_clean_1784893634826.jpg';
  const dstName = 'diaphragm-ccaw-4599.jpg';
  ...
  const productName = "SPEAKER DIAPHRAGM CCAW 45.99 8 OHM";
  const productSlug = "speaker-diaphragm-ccaw-45-99-8-ohm";
  ...
  const { data: productData, error: productError } = await supabase
    ...
    .insert({
      ...
      name: productName,
      slug: productSlug,
      short_desc: "Premium replacement speaker diaphragm featuring an advanced polyimide amber dome and blue anodized mounting rings for 45.99 drivers.",
      long_desc: "This premium replacement speaker diaphragm features a custom polyimide amber dome surround, protective center mesh, and dual blue-anodized mounting rings tailored for 45.99 professional compression drivers. Wound with high-temperature Copper Clad Aluminum Wire (CCAW) on a stable former, it provides clean, precise high-frequency response and superior power handling. Ideal for professional sound reinforcement and wholesale parts distribution.",
      ...
      sort_order: 0,
      seo_meta: {
        title: "SPEAKER DIAPHRAGM CCAW 45.99 8 OHM | Global Speaker Parts",
        description: "Premium replacement speaker diaphragm with polyimide amber dome for 45.99 drivers."
      }
    })
    .select()
    .single();
  ...
  const { data: variantData, error: variantError } = await supabase
    ...
    .insert({
      ...
      name: "CCAW 45.99 8 OHM",
      price: 6.00,
      stock: 1000,
      is_active: true,
      sort_order: 1,
      specs: {
        "Material": "Polyimide Amber Dome / Blue Anodized Aluminum Rings / CCAW Voice Coil",
        "Impedance": "8 Ohm",
  ...
  console.log("45.99 Diaphragm product listing fully complete!");
}
