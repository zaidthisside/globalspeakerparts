...
async function main() {
  ...
  const srcName = 'media__1784956954462.jpg';
  const dstName = 'surround-82-127.jpg';
  ...
  const productName = "SPEAKER FOAM SURROUND ID-82 MM, OD-127 MM";
  const productSlug = "speaker-foam-surround-id-82-mm-od-127-mm";
  ...
  const { data: productData, error: productError } = await supabase
    ...
    .insert({
      ...
      name: productName,
      slug: productSlug,
      short_desc: "Premium speaker foam surround replacement edge featuring a 127 mm outer diameter and 82 mm inner diameter.",
      long_desc: "This premium speaker foam surround is engineered for precision repairs of woofers and midrange drivers. Crafted from durable, highly flexible black foam, it provides excellent excursion compliance and resonance damping to restore original sound quality. Fits standard 5-inch drivers requiring precise ID-82mm and OD-127mm alignment.",
      ...
      sort_order: 0,
      seo_meta: {
        title: "Speaker Foam Surround ID 82mm OD 127mm Edge | Global Speaker Parts",
        description: "Premium replacement speaker foam surround edge for driver repair. Specs: OD 127mm, ID 82mm, Roll 119mm, Piston 90mm."
      }
    })
    .select()
    .single();
  ...
  const { data: variantData, error: variantError } = await supabase
    ...
    .insert({
      ...
      specs: {
        ...
        "Outer Diameter (OD)": "127 mm",
        "Inner Diameter (ID)": "82 mm",
        "Roll Diameter": "119 mm",
  ...
  console.log("Foam Surround 82-127 product listing fully complete!");
}
